    ...
    <div className="bg-black text-white font-raleway">
      ...
      <section className="py-20 px-6 sm:px-12 lg:px-24">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:order-1 text-center lg:text-left">
            <h2 className="text-5xl font-bold text-yellow-400 mb-6 font-lora italic">Our Story</h2>
      ...
      <section className="py-24 px-6 sm:px-12 lg:px-24 bg-black">
        <div className="container mx-auto text-center">
          <h2 className="text-5xl font-bold text-yellow-400 mb-8 font-lora italic">Our Mission</h2>
      ...
      {/* Our Vision Section */}
      <section className="py-28 px-6 sm:px-12 lg:px-24 relative">
        ...
        <div className="relative container mx-auto flex flex-col justify-center items-center text-center py-20 bg-opacity-60 bg-black rounded-lg">
          <h2 className="text-5xl font-bold text-yellow-400 mb-8 font-lora italic">Our Vision</h2>
      ...
      <section className="py-24 px-6 sm:px-12 lg:px-24 text-center bg-black">
        <div className="container mx-auto">
          <h2 className="text-5xl font-bold text-yellow-400 mb-8 font-lora italic">Experience BlackCava</h2>
          ...
          <button className="px-8 py-4 bg-yellow-500 text-black font-semibold rounded-full shadow-lg hover:bg-yellow-400 transform hover:scale-110 transition-transform duration-300">
            Discover Our Blends
          </button>
        </div>
      </section>
